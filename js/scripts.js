  ...
  $('#registrationForm')
    ...
    .on('submit', function (event) {
      if (event.isDefaultPrevented()) {
        ...
        rformError()
        rsubmitMSG(false, 'Mohon untuk mengisi seluruh data pada form!')
      } else {
  ...
  $('#newsletterForm')
    ...
    .on('submit', function (event) {
      if (event.isDefaultPrevented()) {
        // handle the invalid form...
        nformError()
        nsubmitMSG(false, 'Mohon untuk mengisi seluruh data pada form!')
      } else {
        // everything looks good!
        event.preventDefault()
        nsubmitForm()
  ...
  $('#contactForm')
    ...
    .on('submit', function (event) {
      if (event.isDefaultPrevented()) {
        // handle the invalid form...
        cformError()
        csubmitMSG(false, 'Mohon untuk mengisi seluruh data pada form!')
      } else {
        // everything looks good!
        event.preventDefault()
        csubmitForm()
  ...
  $('#privacyForm')
    ...
    .on('submit', function (event) {
      if (event.isDefaultPrevented()) {
        // handle the invalid form...
        pformError()
        psubmitMSG(false, 'Mohon untuk mengisi seluruh data pada form!')
      } else {
        // everything looks good!
        event.preventDefault()
        psubmitForm()
